...
if __name__ == '__main__':
    ...
    recal=[]
    all=[]
    train_dataset = SeqDataset(path="/home/mao/23Spring/cars/racing_car_data/record/test/img/",label='/home/mao/23Spring/cars/racing_car_data/record/test/labels.npy')
